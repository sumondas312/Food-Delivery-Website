(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["ng-image-slider"] = {}, global.ng.core, global.ng.common, global.ng.platformBrowser));
    ...
    var NgImageSliderService = /** @class */ (function () {
        ...
        NgImageSliderService.prototype.orderArray = function (arr, orderType) {
            if (arr === void 0) { arr = []; }
    ...
    ***************************************************************************** */
    ...
    var NEXT_ARROW_CLICK_MESSAGE = 'next', PREV_ARROW_CLICK_MESSAGE = 'previous';
    var NgImageSliderComponent = /** @class */ (function () {
        ...
        NgImageSliderComponent.prototype.setSliderImages = function (imgObj) {
            if (imgObj && imgObj instanceof Array && imgObj.length) {
                var sliderOrderEnable = imgObj.find(function (img) {
                ...
                this.imageObj = imgObj.map(function (img, index) {
                    img['index'] = index;
                    return img;
                });
        ...
        NgImageSliderComponent.prototype.setSliderWidth = function () {
            ...
            if (common.isPlatformBrowser(core.PLATFORM_ID)) {
         ...
         */
        NgImageSliderComponent.prototype.sliderArrowDisableTeam = function (msg) {
            var _this = this;
        ...
        NgImageSliderComponent.prototype.nextPrevSliderButtonDisable = function (msg) {
            this.sliderNextDisable = false;
            this.sliderPrevDisable = false;
            var actionMsg = {};
            if (!this.infinite) {
        ...
        NgImageSliderComponent.prototype.lightboxArrowClickHandler = function (event) {
    ...
    var SliderCustomImageComponent = /** @class */ (function () {
        ...
        SliderCustomImageComponent.prototype.ngOnChanges = function (changes) {
            if (this.imageUrl
                && this.imageUrl
                && this.imageUrl
        ...
        SliderCustomImageComponent.prototype.setUrl = function () {
    ...
    var SliderLightboxComponent = /** @class */ (function () {
        ...
        SliderLightboxComponent.prototype.onResize = function (event) {
            this.effectStyle = 'none';
            this.setPopupSliderWidth();
        };
        ...
        SliderLightboxComponent.prototype.setPopupSliderWidth = function () {
            var _this = this;
         ...
         * Reference from https://stackoverflow.com/a/44511007/2067646
         */
        SliderLightboxComponent.prototype.swipeLightboxImg = function (e, when) {
            var coord = [e.changedTouches[0].pageX, e.changedTouches[0].pageY];
            var time = new Date().getTime();
            if (when === 'start') {
